...
namespace Aurora.Forms.CustomControls.GroupedComboBox.GroupedComboBox
{
    /// <summary>
    ...
    public class GroupedComboBox : ComboBox, IComparer
    {
        ...
        /// <returns></returns>
        private PushButtonState GetPushButtonState(ComboBoxState combo)
        {
            switch (combo)
            {
        ...
        private void _bufferedPainter_PaintVisualState(object sender, BufferedPaintEventArgs<ComboBoxState> e)
        {
            ...
            Rectangle buttonBounds = new Rectangle(Width - 17, 0, 17, Height - (e.State != ComboBoxState.Pressed ? 1 : 0));
