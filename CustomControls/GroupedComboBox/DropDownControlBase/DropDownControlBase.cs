...
using Aurora.Forms.CustomControls.GroupedComboBox.BufferedPaint;

namespace Aurora.Forms.CustomControls.GroupedComboBox.DropDownControlBase
{
    /// <summary>
    ...
    public abstract class DropDownControlBase : Control
    {
        ...
        private readonly BufferedPainter<ComboBoxState> _bufferedPainter;
        ...
        private ButtonState GetPlainButtonState()
        {
            ...
            else if (_droppedDown || (_dropDownButtonBounds.Contains(PointToClient(Cursor.Position)) && ((MouseButtons & MouseButtons.Left) == MouseButtons.Left)))
